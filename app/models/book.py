   ...
   # relationships:
    ...
    def serialize(self):
        return {
            "id": self.id,
            "title": self.title,
            "author": self.author.serialize() if hasattr(self.author, 'serialize') else self.author,
            ...
            "availability_status": self.availabilaty_status,
            ...
            "is_new": self.is_new() if hasattr(self, "is_new") else False,
            "images": [img.serialize() for img in self.images] if hasattr(self, "images") else [],
            "wishlist_items": [item.serialize() for item in self.wishlist_items] if hasattr(self, "wishlist_items") else [],
            "purchased_by": [lib.id for lib in self.purchased_by] if hasattr(self, "purchased_by") else [],
        }
